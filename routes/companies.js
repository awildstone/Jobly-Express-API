...
router.patch("/:handle", ensureLoggedIn, isAuthorized, async function (req, res, next) {
  try {
...
router.delete("/:handle", ensureLoggedIn, isAuthorized, async function (req, res, next) {
  try {
